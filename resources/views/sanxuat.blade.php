...
<body class="">
  ...
  <div class="d-flex" >
    ...
    <center><h1>Linh kiện</h1></center>
      <div class="modal" id="myModal">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <!-- Modal Header -->
          <div class="modal-header">
            <h4 class="modal-title">Thêm mới linh kiện</h4>
          ...
          <form action="first.php" method="post">
              <div class="row">
                ...
                <div class="col-6">
                  <span>Tên linh kiện</span>
                  <input type="file"class="form-control" id="exampleInputEmail11"  accept="image/png, image/gif, image/jpeg"  />
                </div>
                <div class="col-12">
